...
* **AI applications using GPUs.** (2025, February 13). Aethir. [cite_start][https://ecosystem.aethir.com/blog-posts/ai-applications-using-gpus-enhancing-computational-efficiency-and-performance](https://ecosystem.aethir.com/blog-posts/ai-applications-using-gpus-enhancing-computational-efficiency-and-performance) [cite: 113, 114, 115]
* **Bailey, R.** (2025, July 21). *GPU applications: What are the main applications for GPUs?* Atlantic.Net. [cite_start][https://www.atlantic.net/gpu-server-hosting/gpu-applications-what-are-the-main-applications-for-gpus/](https://www.atlantic.net/gpu-server-hosting/gpu-applications-what-are-the-main-applications-for-gpus/) [cite: 116, 117, 118]
* **Caputo, A. C.** (2014). *DVS archiving and storage.* In Elsevier eBooks (pp. 293-330). [cite_start][https://doi.org/10.1016/b978-0-12-420042-5.00009-5](https://doi.org/10.1016/b978-0-12-420042-5.00009-5) [cite: 119, 120]
* **Caulfield, B.** (2009, December 16). *What's the difference between a CPU and a GPU?* NVIDIA Blog. [cite_start][https://blogs.nvidia.com/blog/whats-the-difference-between-a-cpu-and-a-gpu/](https://blogs.nvidia.com/blog/whats-the-difference-between-a-cpu-and-a-gpu/) [cite: 121, 122, 123]
* **CDW.** (2025, January 22). *CPU vs. GPU: What's the difference?* CDW Research Hub. [cite_start][https://www.cdw.com/content/cdw/en/articles/hardware/cpu-vs-gpu.html](https://www.cdw.com/content/cdw/en/articles/hardware/cpu-vs-gpu.html) [cite: 124, 125]
* **Cho, K., & Bahn, H.** (2020). [cite_start]*Performance analysis of thread block schedulers in GPGPU and its implications.* Applied Sciences, 10(24), 9121. [https://doi.org/10.3390/app10249121](https://doi.org/10.3390/app10249121) [cite: 126, 127, 128]
* **CPU vs GPU: What's the difference and which one should you use?** (n.d.). Codecademy. [cite_start][https://www.codecademy.com/article/cpu-vs-gpu-whats-the-difference-and-which-one-should-you-use](https://www.codecademy.com/article/cpu-vs-gpu-whats-the-difference-and-which-one-should-you-use) [cite: 129, 130, 131]
